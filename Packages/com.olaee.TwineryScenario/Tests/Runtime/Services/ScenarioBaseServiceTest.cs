...
{
    public class ScenarioBaseServiceTest
    {
        [Test]
        public void TestSetScenarioSame()
        {
            ...
            ScenarioBaseService service = obj.AddComponent<ScenarioBaseService>();
        ...
        public void TestInitScenario()
        {
            ...
            string testFileName = "test-scenario-3";
            ...
            Assert.IsTrue(service.GetScenario().name == "Scenario Base Test");
